...
function Channel(pvName) {
  ...
  self.get = function(options, callback) {
    ...
    var fieldType = 'fieldType' in options ? options.fieldType : self.fieldType;
    var getCallbackPtr = new ffi.Callback('void',[evargs_t],function(args) {
      ...
      var value = coerceBufferToNativeType(args.dbr, args.type, self.count);
      if(callback) {
        callback(null, value);
      }
    ...
    var usrArg = null;
    var err = libca.ca_array_get_callback(fieldType, self.count,
  ...
  self.monitor = function(options) {
    ...
    var usrArg = null;
    var err = libca.ca_create_subscription(self.fieldType, self.count,
  ...
  self.put = function(value, callback) {
    ...
    if (self.fieldType === dbr.STRING) {
      ...
      var PutArrayType = ArrayType(ref.types[nativeType[self.fieldType]]);
      var array = new PutArrayType(value);
      buf = array.buffer;
    }
    var errCode = libca.ca_array_put_callback(self.fieldType, count,
