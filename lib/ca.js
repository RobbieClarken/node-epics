...
var LIBCA_PATH = '/epics/base/lib/darwin-x86/libca.dylib';
...
var libca = ffi.Library(LIBCA_PATH,{
  ...
  ca_name: ['string',[ 'long' ]],
  ca_array_get: ['int',['int','ulong','long','pointer']],
  ca_array_get_callback: ['int',['int','ulong','long','pointer','pointer']],
  ca_create_subscription: ['int',['int','ulong','long','long','pointer','pointer','pointer']]
});
...
function Channel(pvName) {
  ...
  self.connect = function(callback) {
    var chidPtr = new Buffer(ref.sizeof.long);
    chidPtr.writeInt64LE(0, 0)
    chidPtr.type = ffi.types.long;
